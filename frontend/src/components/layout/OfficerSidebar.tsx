...
const navItems = [
  ...
  { href: '/officer/applications', label: 'Applications', icon: ClipboardList   },
  { href: '/officer/grievances',   label: 'Grievances',   icon: MessageSquare   },
]
    ...
    <aside className="fixed left-0 top-0 h-full w-64 bg-white border-r border-gray-200 flex flex-col z-40">
      ...
      <div className="flex items-center gap-3 px-6 py-5 border-b border-gray-100">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500">Officer Panel</p>
        </div>
      </div>
